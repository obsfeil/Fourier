...
time_ms = np.arange(start_time_ms, end_time_ms)  # opprett tid i millisekunder
time = time_ms / 1000  # konverter tid til sekunder
...
time = np.arange(start_time_ms, end_time_ms) / time_scale  # oppdater tid til ønsket enhet
