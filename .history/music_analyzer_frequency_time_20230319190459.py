...
time_interval = 0.001 # tidsintervall i sekunder, endres etter behov
...
fig, ax = plt.subplots()
ax.plot(time, frequency, label='frequency')
ax.plot(time, amplitude_normalized, label='amplitude')
ax.set_xlabel(f"Time ({time_unit})")
ax.set_ylabel("Hz / Amplitude (normalized)")
ax.set_title("Frequency and Amplitude over Time")
ax.legend()
plt.show()
