...
start_time_ms = 1
end_time_ms = 10
start_index = int(start_time_ms * sampling_rate / 10000000)
end_index = int(end_time_ms * sampling_rate / 10000000)
...
time_ms = np.arange(start_index, end_index) / sampling_rate * 10000000
