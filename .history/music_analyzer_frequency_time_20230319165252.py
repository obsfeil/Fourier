...
# Velg tidsintervall å plotte (her fra 0 til varigheten av lydfilen i millisekunder)
start_time_ms = 10
end_time_ms = len(data) * 1000 // sampling_rate
...
# time_s = np.arange(start_index, end_index) / sampling_rate * 1
# time_us = np.arange(start_index, end_index) / sampling_rate * 1000000
